...
var particles = new THREE.Points(geometry, new THREE.PointsMaterial({ color: 0xe6e600, size: 2 }));
...
gsap.to(animProps, {
    duration: 10, scale: 1, repeat: -1, yoyo: true, ease: "sine", onUpdate: function () {
